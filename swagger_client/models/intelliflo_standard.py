...
class IntellifloStandard(BaseConfigurationDocument):
    ...
    def __init__(self, config=None, *args, **kwargs):  # noqa: E501
        """IntellifloStandard - a model defined in Swagger"""  # noqa: E501
        self._config = None
    ...
    @property
    def config(self):
        """Gets the config of this IntellifloStandard.  # noqa: E501


        :return: The config of this IntellifloStandard.  # noqa: E501
    ...
    def config(self, config):
        """Sets the config of this IntellifloStandard.


        :param config: The config of this IntellifloStandard.  # noqa: E501
        :type: AmazonS3Config
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IntellifloStandard, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntellifloStandard):
            return False
