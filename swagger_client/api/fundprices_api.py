...
class FundpricesApi(object):
    ...
    def list_fund_prices(self, authorization, fund_id, x_api_key, **kwargs):  # noqa: E501
        ...
        **Note:** Use of the this API is subject to specific terms of use.   The data obtained from this API may be used to drive UI applications where the users are licensed Intelligent Office users or customers thereof. Valid use cases fall within the production of print or other media as part of the normal course of financial services business.  The data from this API may **not** be extracted in bulk or redistributed for any purposes other than those stated above. Please be aware that any consumers that operate outside of these terms may have access to these endpoints removed or restricted. If in doubt, please contact us to discuss your use case and we can advise further.   # noqa: E501
        ...
        >>> thread = api.list_fund_prices(authorization, fund_id, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        :param str accept:
        :param str filter: Supported operator(s): `lt`, `le`, `gt`, `gt` and `eq`. Available Field(s) `date`
        :param int skip: Number of records to skip. Must be greater than or equal to zero
        :param int tenant_id: Tenant identifier
        :param int top: The number of records to retrieve (default 100, max 1100)
        ...
        if kwargs.get('async_req'):
            return self.list_fund_prices_with_http_info(authorization, fund_id, x_api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.list_fund_prices_with_http_info(authorization, fund_id, x_api_key, **kwargs)  # noqa: E501
            return data

    def list_fund_prices_with_http_info(self, authorization, fund_id, x_api_key, **kwargs):  # noqa: E501
        """Returns a list of fund prices for a given fund.   # noqa: E501

        **Note:** Use of the this API is subject to specific terms of use.   The data obtained from this API may be used to drive UI applications where the users are licensed Intelligent Office users or customers thereof. Valid use cases fall within the production of print or other media as part of the normal course of financial services business.  The data from this API may **not** be extracted in bulk or redistributed for any purposes other than those stated above. Please be aware that any consumers that operate outside of these terms may have access to these endpoints removed or restricted. If in doubt, please contact us to discuss your use case and we can advise further.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_fund_prices_with_http_info(authorization, fund_id, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'fund_id', 'x_api_key', 'accept', 'filter', 'skip', 'tenant_id', 'top']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_fund_prices" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `list_fund_prices`")  # noqa: E501
        # verify the required parameter 'fund_id' is set
        if ('fund_id' not in params or
                params['fund_id'] is None):
            raise ValueError("Missing the required parameter `fund_id` when calling `list_fund_prices`")  # noqa: E501
        # verify the required parameter 'x_api_key' is set
        if ('x_api_key' not in params or
                params['x_api_key'] is None):
            raise ValueError("Missing the required parameter `x_api_key` when calling `list_fund_prices`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='FundPriceCollection',  # noqa: E501
